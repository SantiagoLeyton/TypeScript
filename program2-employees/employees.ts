...
function searchEmployee(): void {
  ...
  const result = document.getElementById("searchResult") as HTMLParagraphElement;
...
function showAllEmployees(): void {
  const list = document.getElementById("employeeList") as HTMLUListElement;
...
function calculateAverage(): void {
  const result = document.getElementById("averageResult") as HTMLParagraphElement;
